    ...
    <>  
        ...
        <main className="mt-5 flex flex-col gap-8 bg-purple-200 p-4">
            ...
            <div className="text-center text-white">
                <div>"Odds & Ends is the Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco."</div>  
            </div>
            <h1 className="text-center text-white">Our Goals</h1>
            <SlidingBox />
            <div className="text-center text-white">"Odds & Ends is the Lorem ipsum dolor sit amet, consectetur adipiscing elit."</div> 
